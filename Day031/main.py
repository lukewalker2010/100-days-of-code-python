...
try:
    ...
    origional_data = pandas.read_csv("Day031/data/french_words.csv")
...
card_front_image = PhotoImage(file="Day031/images/card_front.png")
card_back_image = PhotoImage(file="Day031/images/card_back.png")
